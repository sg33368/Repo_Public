...
echo "test starting"
nohup sh C:/Users/pa_sg33368/Downloads/apache-jmeter-5.4.3/apache-jmeter-5.4.3/bin/jmeter.sh -Jjmeter.save.saveservice.output_format=csv -n -t ./$sciptName -f -l ./$projectName.jtl -e -o ./HTMLReport_$time
